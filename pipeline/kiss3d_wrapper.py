...
from pipeline.p2p_utils import AttentionControlEdit, FluxP2PAttnProcessor, AttentionStore, EmptyControl, AttentionReplace, AttentionRefine
...
class kiss3d_wrapper(object):
    ...
    def generate_3d_bundle_image_p2p(self, source_prompt, target_prompt,
                                     ...
                                     p2p_mode="replace", # replace, refine
                                     lora_scale=1.0,
                                     num_inference_steps=None,
                                     seed=None,
                                     save_intermediate_results=True,
        ...
        # Select Controller
        tokenizer = flux_pipeline.tokenizer_2
        ...
        if p2p_mode == "refine":
            ...
            controller = AttentionReplace(
             ...
             # Fallback to basic Edit (no mapper)
...
def run_p2p_edit(k3d_wrapper, source_prompt, target_prompt, init_image_path=None, p2p_mode="replace"):
    """
    ...
    logger.info(f"P2P Edit ({p2p_mode}): {source_prompt} -> {target_prompt}")
    
    # Refine prompts? Maybe not for P2P control as strict alignment is better.
    # source_prompt = k3d_wrapper.get_detailed_prompt(source_prompt)
    # target_prompt = k3d_wrapper.get_detailed_prompt(target_prompt)
